...
> Backlog auditado contra el código fuente disponible el 22 de julio de 2026.
>
...
| 2 | Deferred Frames / @Defer          | 🟡 Funcional, falta endurecimiento        | P0: endurecer         |
...
* [ ] Evitar que la única ruta de publicación dependa de -DskipTests.
* [ ] Definir cobertura mínima por módulos críticos: core, APT, runtime JVM y runtime JS.
...
* [ ] Añadir pruebas dedicadas para anotación, APT, runtime JVM y runtime JS.
* [ ] Definir estado de error visible y fallback de error.
* [ ] Añadir timeout configurable.
* [ ] Definir cancelación cuando el componente se desmonta o cambia la ruta.
* [ ] Evitar ejecuciones duplicadas durante reconexiones o reinicializaciones.
...
2. Pruebas y endurecimiento de @Defer.
3. Pruebas y endurecimiento del generador de Web Components.
4. Protocolo formal de resurrección de estado.
5. Data Streams MVP.
6. Hibernate Bridge after-commit.
7. Offline/PWA.

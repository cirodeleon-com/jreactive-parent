          ...
          <div class="home-container">
              ...
              <div class="grid-dashboard">
                  ...
                  <JCard title="📝 Formularios & Datos" subtitle="Entradas y validaciones">
                      ...
                      <a class="nav-link" href="/secure-demo" data-router><span class="nav-icon">🔒</span> Demo Segura (Roles)</a>
                  ...
                  <JCard title="🔐 Seguridad" subtitle="Autorización basada en roles">
                      <a class="nav-link" href="/secure" data-router><span class="nav-icon">🔒</span> @Authorize Demo</a>
                      <a class="nav-link" href="/demo/me"><span class="nav-icon">👤</span> ¿Quién soy? (/demo/me)</a>
                  </JCard>
